...
A new instance of TType which contains [first](Overload_T1,T2,T3,T4_.op_Implicit.2FfclR5lk0pYqE6JqvdMGQ.md#Emik.Unions.Disjoints.Overload_T1,T2,T3,T4_.op_ImplicitEmik.Unions.Disjoints.Overload_T1,T2,T3,T4_(T1).first 'Emik.Unions.Disjoints.Overload<T1,T2,T3,T4>.op_Implicit Emik.Unions.Disjoints.Overload<T1,T2,T3,T4>(T1).first').