...
## Either<T1,T2,T3,T4,T5,TType>.New(T1) Method
...
<a name='Emik.Unions.Disjoints.Either_T1,T2,T3,T4,T5,TType_.New(T1).first'></a>

`first` [T1](Either_T1,T2,T3,T4,T5,TType_.md#Emik.Unions.Disjoints.Either_T1,T2,T3,T4,T5,TType_.T1 'Emik.Unions.Disjoints.Either<T1,T2,T3,T4,T5,TType>.T1')
...
A new instance of [TType](Either_T1,T2,T3,T4,T5,TType_.md#Emik.Unions.Disjoints.Either_T1,T2,T3,T4,T5,TType_.TType 'Emik.Unions.Disjoints.Either<T1,T2,T3,T4,T5,TType>.TType') which contains [first](Either_T1,T2,T3,T4,T5,TType_.New(T1).md#Emik.Unions.Disjoints.Either_T1,T2,T3,T4,T5,TType_.New(T1).first 'Emik.Unions.Disjoints.Either<T1,T2,T3,T4,T5,TType>.New(T1).first').