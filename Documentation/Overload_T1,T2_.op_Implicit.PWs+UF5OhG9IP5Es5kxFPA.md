...
A new instance of TType which contains [first](Overload_T1,T2_.op_Implicit.PWs+UF5OhG9IP5Es5kxFPA.md#Emik.Unions.Disjoints.Overload_T1,T2_.op_ImplicitEmik.Unions.Disjoints.Overload_T1,T2_(T1).first 'Emik.Unions.Disjoints.Overload<T1,T2>.op_Implicit Emik.Unions.Disjoints.Overload<T1,T2>(T1).first').