...
## Product<T1,T2,T3,TType>.this[string] Property
...
<a name='Emik.Unions.Tagged.Product_T1,T2,T3,TType_.this[string].name'></a>

`name` [System.String](https://docs.microsoft.com/en-us/dotnet/api/System.String 'System.String')

The property name to get its value.

Implements [this[string]](IProduct.Item.tuw4+xipn0nfgJsCM5/YdQ.md 'Emik.Unions.Tagged.IProduct.this[string]')
