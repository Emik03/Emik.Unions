...
`first` [T1](Either{T1,T2,T3,T4,T5,TType}.md#Emik.Unions.Disjoints.Either_T1,T2,T3,T4,T5,TType_.T1 'Emik.Unions.Disjoints.Either<T1,T2,T3,T4,T5,TType>.T1')
